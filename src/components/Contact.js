  ...
  render(){
    return(
      ...
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
        ...
        <h2 className='py-4 text-yellow-400'>Get In Touch</h2>
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2'>Tofer Sokolosky</h2>
              ...
              <div>
                ...
                <div className='flex items-center justify-between py-4'>
                  <a
                    href='https://www.linkedin.com/in/tofer-sokolosky/'
                    target='_blank'
                    rel='noreferrer'
                  >
                  ...
                  <a
                    href='https://github.com/Esoteric918'
                    target='_blank'
                    rel='noreferrer'
                  >
                    <div className='rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300'>
                  ...
                  <a href='/resume'>
                      ...
                      <div className='rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300' alt="Resume">
                        <a href="https://docs.google.com/document/d/1VqhulpwMihIJ8gjYCxnV3eKZJLAmWhVBRaOrCBK2G8c/edit?usp=sharing">
                          <BsFillPersonLinesFill className='text-yellow-500'/>
                        </a>
